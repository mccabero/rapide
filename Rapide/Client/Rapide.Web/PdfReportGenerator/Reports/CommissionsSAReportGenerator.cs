...
{
    public static class CommissionsSAReportGenerator
    {
            ...
            List<UserDTO> techniciansDto)
        {
            ...
            var rootFileName = $"COMMISSIONS-SA-{dateCoverage.ToUpper()}.pdf";
        ...
        private static void ComposeContent(IContainer container)
        {
            ...
            {
                column.Spacing(1);
                column.Item().Text($"COMMISSIONS SA REPORT").FontSize(12).Bold().Underline().AlignCenter();
                ...
                column.Item().Table(table =>
                {
                    ...
                    foreach (var i in invoice)
                    {
                        ...
                        foreach (var t in serviceAdvisor)
                        {
                            ...
                            {
                                table.Cell().Element(CellStyle).PaddingRight(45).Text(i.TotalAmount > 0 ? i.TotalAmount.ToString("N2") : "-").AlignRight();
                            }
                            else
                            {
                ...
                column.Item().Table(table =>
                {
                    ...
                    table.Footer(footer =>
                    {
                        ...
                        foreach (var t in serviceAdvisor)
                        {
                            ...
                            foreach (var i in invoice)
                            {
                                if (i.JobOrder.AdvisorUser.Id == t.Id)
